...
namespace TicketType.Microservice.Template.UnitTests.Stubs
{
    ...
    public static class JsonStub
    {
        ...
        {
            return @"{""Type"":""Notification"",""MessageId"":""720c5d59-981b-5d4d-a5d5-07d0424134bc"","
                   + @"""TopicArn"":""arn:aws:sns:us-east-1:663374859601:eng-solution-orchestrator"","
                   + @"""Message"":{""Id"":""03fa2bb8-50ac-42d1-9d84-04f860462c8c"",""JobId"":""9ca8c5a9-51b2-471a-9020-cb628c0a5fe9"","
                   ...
                   + @"""EventType"":""" + eventType + @""",""TaskType"":""TriggerEvent"",""Metadata"":{""Record"":""entity-importer/Tractors-AO-1105-131666917.csv"","
                   + @"""Bucket"":""eng-entity-import-01pb673zvt4fi4y3"",""EntityType"":""" + entityType + @"""}},""Timestamp"":""2022-02-18T17:32:10.373Z"","
                   + @"""SignatureVersion"":""1"",""Signature"":"""","
                   ...
                   + @"""MessageAttributes"":{""workflow_version"":{""Type"":""String"",""Value"":""4e6165f2-af47-495c-965a-4a1036850c2b""},"
                   + @"""event_type"":{""Type"":""String"",""Value"":""task_Started""},""job_name"":{""Type"":""String"",""Value"":""CsvImport""},"
